          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 p-3 rounded text-xs font-mono text-gray-700">
                ...
                <br />
                timestamp=2024-01-15 08:31:00 sourceip=203.0.113.50 destip=10.0.0.1 destport=22 subsys=ips action=blocked
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 p-3 rounded text-xs font-mono text-gray-700">
                timestamp,sourceip,destip,destport,subsys,action
                <br />
                2024-01-15 08:30:00,192.168.1.100,10.0.0.50,443,firewall,allow
                <br />
                2024-01-15 08:31:00,203.0.113.50,10.0.0.1,22,ips,blocked
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 p-3 rounded text-xs font-mono text-gray-700">
                [
                <br />
                &nbsp;&nbsp;{'{'}timestamp: "2024-01-15 08:30:00", sourceip: "192.168.1.100", ...{'}'}
                <br />
                ]
              </div>
            </div>
